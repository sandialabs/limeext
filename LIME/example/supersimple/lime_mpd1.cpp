...
// using the following Model Evaluators: CON1D_ModelEval0, and THINWALL_ModelEval0
// 
// ********************************************************************************************
//
...
int main(int argc, char *argv[]) {
  ...
  try {    // the "try" construct is used to allow for catching "exceptions" that might
    ...
    // 3  Create pointers to an instance of a "CON1D_ModelEval1" object called "con1d"
    //    and an instance of a "THINWALL_ModelEval1" object called "thinwall" 
