...
! MODULE     neutron_mod
! PROGRAM    ss_neutron
! SUBROUTINE setup_neutron
! SUBROUTINE solve_neutron
! SUBROUTINE rhs_neutron
! SUBROUTINE residual_neutron
! SUBROUTINE finish_neutron
!*****************************************************************************************
...
! Problem Setup
  ...
  CALL solve_neutron ! initialize q with initial T
  uout   = 9        ! standard output goes to unit 6
  if(uout.ne.6)   OPEN(unit=uout, file='neutron_out', status='unknown')

END SUBROUTINE setup_neutron
! ========================
...
! Solve problem - which in this case is simply an assignment
...
END SUBROUTINE residual_neutron
! ========================
...
! Solve problem
  DO j=1,3   ! Loop over the three X locations in the wall
     ...
     ! Energy Release
     RHS(j) = -Cnq*(I(j)-I(j-1))/dx

  END DO
    
END SUBROUTINE rhs_neutron
! ========================
