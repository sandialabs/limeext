...
//
// lime_mpd_all.cpp
// This is a LIME driver for coupling the "super-simple" codes con1d, neutron, and thinwall
// using the following Model Evaluators: 
...
int main(int argc, char *argv[]) {
  ...
  try {    // the "try" construct is used to allow for catching "exceptions" that might
    ...
    //    an instance of a "CON1D_ModelEval1" object called "con1d", and 
    //    an instance of a "NEUTRON_ModelEval1" object called "neutron", and 
    //    an instance of a "THINWALL_ModelEval1" object called "thinwall" 
    //    (on the heap)
    ...
    //    the Problem manager
          ...
          // Optional way to directly set max_fixed_point_iterations 
    ...
    // 8 Test that we converged to the "correct" answer
           ...
           error = std::max( error, abs((Twall - gold_w_temp)/gold_w_temp) );
