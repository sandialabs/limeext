...
// in LIME by #including the file LIME_fortran_mangling.h
 ...
 extern "C" {
  ...
  extern double thinwall_t[1];   //     thinwall temperature 
  extern double thinwall_trad;   //     thinwall radiation BC temperature 
  extern double thinwall_dt;     //     solution time step
  extern double thinwall_time;   //     current simulation time
  extern double thinwall_r[1];   //     residual value
  extern double thinwall_tol ;   //     convergence tolerance
...
const double THINWALL_ModelEval0::gold_w_temp = 346.6981;
