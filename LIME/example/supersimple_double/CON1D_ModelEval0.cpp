...
const double CON1D_ModelEval0::gold_temps[] = { 523.4678, 491.3500, 383.0898 };
const double CON1D_ModelEval0::gold_temps_w_thinwall[] = { 536.6940, 507.2687, 406.1250 };
