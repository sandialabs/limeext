...
class CON1D_ModelEval0 : public LIME::Model_Evaluator
{
  ...
  public:
   ...
   double* qs; // neutronics will write this data
   double* t;  // neutronics will read this data
   double& trbc; // thinwall will write this data

   // "correct" solutions to verify answers
   static const double gold_temps[];
   static const double gold_temps_w_thinwall[];
};
#endif
